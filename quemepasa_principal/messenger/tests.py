...
class ThreadTestCase(TestCase):
    ...
    def test_add_users_to_thread(self):
        self.thread.users.add(self.user1, self.user2) # Añadimos los usuarios a la isntancia thread
        self.assertEqual(len(self.thread.users.all()), 2) #Acá comprobamos todos los usuarios que hay, y le pasamos la cantidad que debería haber debntro del hilo.
