...
class SignUpView(CreateView):
    ...
    def get_form(self, form_class=None):
        ...
        #form.fields['is_specialist'].widget = forms.CheckboxInput(attrs={'class': 'form-control mb-2', 'placeholder': 'Sos especialista o te dedicas a la salud mental?'})
...
class EmailUpdate(UpdateView):
    ...
    #Vamos a recuperar el usuario
    def get_object(self):
        # recuperamos el objeto que se va a editar, en este caso el usuario
